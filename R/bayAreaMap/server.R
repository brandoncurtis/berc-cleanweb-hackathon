...
#taxisample <- taxiData[sample.int(nrow(taxiData), 100000),]
...
#       addTiles(
#         urlTemplate = "https://stamen-tiles-{s}.a.ssl.fastly.net/terrain-background/{z}/{x}/{y}.{ext}", 
...
#        clearShapes() %>%
#        addCircles(~start_lng, ~start_lat, radius=radius, layerId=~zipcode,
